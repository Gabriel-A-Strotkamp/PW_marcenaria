                        ...
                        <Row>
                            ...
                            <Col xs={12} md={6}>
                                <FloatingLabel controlId="txtCodigo" label="Código" className="mb-3">
                                    <Form.Control type="text" readOnly name="pedidoId"
                            ...
                            <Col xs={12} md={6}>
                                <FloatingLabel controlId="txtDescricao" label="Descrição" className="mb-3">
                                    <Form.Control type="text" required name="descricao"
                                        ...
                                        onChange={handleChange} placeholder="Descrição do pedido" />
                                </FloatingLabel>
                            </Col>

                            <Col xs={12} md={6}>
                                <FloatingLabel controlId="txtOrcamento" label="Orçamento" className="mb-3">
                                    <Form.Control type="number" required name="orcamento"
                            ...
                            <Col xs={12} md={6}>
                                <FloatingLabel controlId="txtDataInicio" label="Data início" className="mb-3">
                                    <Form.Control type="text" required name="data_inicio"
                                        value={objeto.data_inicio}
                                        onChange={handleChange} placeholder="dd/mm/aaaa" />
                                </FloatingLabel>
                            </Col>

                            <Col xs={12} md={12}>
                                <FloatingLabel controlId="txtDataEntrega" label="Data entrega" className="mb-3">
                                    <Form.Control type="text" name="data_entrega"
